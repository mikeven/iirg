<?php
  ...
  if( isset( $_GET["id"] ) ){
    ...
    $idf        = $_GET["id"];
    $factura    = obtenerFacturaProformaPorId( $dbh, $_GET["id"] );
...
<head>
  ...
  <title>IIRG | Editar factura proforma</title>
  ...
  <!-- jQuery 2.1.4 -->
    ...
    <script>
      $( document ).ready(function() {
          iniciarVentanaConfirmacion( "bt_edit_proforma", "Editar factura proforma" );
      });
    </script>
