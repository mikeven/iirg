<?php
	/*
	 * R&G - Registro de facturas proformas
	 * 
	 */
	session_start();
...
<head>
  ...
  <title>IIRG | Registro de Facturas proformas</title>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">LISTA DE FACTURAS PROFORMAS</h3>
                  <a class="btn btn-app" href="nuevo-proforma.php">
                    <i class="fa fa-plus"></i> Nuevo
                  </a>
                  <div class="icon-color">
                    <a href="nuevo-proforma.php"><i class="fa fa-file-text-o fa-2x"></i></a>
                  </div>
                </div><!-- /.box-header -->
             	<div class="box-body">
                	<?php include( "sub-scripts/tablas/tabla_facturas_proforma.php" )?>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!--/.col (left) -->
          </div>  
