            ...
            <div class="col-xs-12 table-responsive">
              <table id="tabla_detalle_doc" class="table">
                ...
                <tbody>
                  ...
                  <?php for( $d = 0; $d<20; $d++ ) { ?>
                  <tr>
                    <td class="tit_tdf_i" align="left">DESCRIPCION</td>
                    <td class="tit_tdf" align="center">CANTIDAD</td>
                    <td class="tit_tdf" align="center">UND</td>
                    <td class="tit_tdf" align="right">PRECIO</td>
                    <td class="tit_tdf" align="right">TOTAL</td>
                  </tr>
                  <?php } //end: foreach ?>
                </tbody>
              </table>
