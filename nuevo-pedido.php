...
<head>
  ...
  <title>IIRG | Crear nuevo pedido</title>
    	...
    	<div class="row">
            ...
            <div class="col-md-12">
              <!-- general form elements -->
                ...
                <!-- form start -->
                <form role="form" id="frm_npedido" name="form_agregar_cotizacion" class="frm_documento">
                            	...
                            	<div id="panel_items">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="hidden" id="und_art" value="">
                                        </div>
                                    </div><!-- /.form group -->
                                    <!-- Modal -->
                                  	...
                                  	<table class="table table-condensed" id="pietabla_table">
                                          <tbody>
                                              ...
                                              <tr>
                                                  ...
                                                  <th width="15%">
                                                  	<div id="ped_total" class="totalizacion">
                                                      	<div class="input-group">
                                                      		<input type="text" class="form-control itemtotaldocumento totalizacion" 
                    ...
                    <div class="box-footer" align="center">
                    	<button type="button" class="btn btn-primary blq_bdoc" id="btn_confirmacion" data-toggle="modal" 
