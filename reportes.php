                    ...
                    <div class="box-body">
                      <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                          <b>Relación de gastos</b> <a class="pull-right"><i class="fa fa-cart-arrow-down"></i></a>
                        </li>
                        <li class="list-group-item">
                          <b>Pago de facturas</b> <a class="pull-right"><i class="fa fa-reply"></i></a>
                        </li>
                        <li class="list-group-item">
                          <b>Libro de Ventas</b> <a class="pull-right"><i class="fa fa-book"></i></a>
                        </li>
                        <li class="list-group-item">
                          <b>Libro de Compras</b> <a class="pull-right"><i class="fa fa-book"></i></a>
                        </li>
                        <li class="list-group-item">
                          <b>Facturas por cobrar</b> <a class="pull-right"><i class="fa fa-clock-o"></i></a>
                        </li>
                      </ul>
                    </div>
                  </div>
